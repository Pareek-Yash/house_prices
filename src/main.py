...
def header_text():
    with me.box(
        ...
        me.text(
            "Transformer based Chat Generation",
            style=me.Style(
                font_size=36,
                font_weight=700,
...
def generated_text(input):
    return "This is TODO using transformers"


def call_api(input):
    # Replace this with an actual API call
    out = generated_text(input)
    time.sleep(0.5)
...
def footer():
    with me.box(
        ...
        me.html(
            "Go back to <a href='https://google.github.io/mesop/'>Home</a>",
        )
